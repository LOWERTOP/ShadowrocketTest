[![Shadowrocket](https://socialify.git.ci/LOWERTOP/Shadowrocket/image?custom_description=%E4%BD%BF%E7%94%A8%E6%89%8B%E5%86%8C&description=1&font=Raleway&logo=https%3A%2F%2Fshadowlaunch.com%2Fstatic%2Ficon.png&name=1&pattern=Diagonal+Stripes&theme=Light)](https://shadowlaunch.com/ "官方软件介绍页面")
...
Shadowrocket 使用手册原始仓库已不可达，本仓库继承其最终文件进行后续更新
...
这是错误的，为了可以访问，Shadowrocket会主动开启允许不安全。在`2.2.23`等特定版本中，该选项可能默认为关闭状态。
...
__注意：iOS 14 及之前的系统中，NE的内存限制15 MB，iOS 15之后增加到了 50 MB。低版本系统或设备可能存在内存不足导致模块失效或代理软件异常关闭__
